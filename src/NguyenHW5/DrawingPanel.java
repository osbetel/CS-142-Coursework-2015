package NguyenHW5; /**
 The NguyenHW5.DrawingPanel class provides a simple interface for drawing persistent
 images using a Graphics object.  An internal BufferedImage object is used
 to keep track of what has been drawn.  A client of the class simply
 constructs a NguyenHW5.DrawingPanel of a particular size and then draws on it with
 ...
 This version of NguyenHW5.DrawingPanel also saves animated GIFs, though this is kind
...
public final class DrawingPanel extends FileFilter
    ...
    private static void checkAnimationSettings() {
        try {
            ...
            if (settingsFile.exists()) {
                ...
                System.out.println("***");
                System.out.println("*** NguyenHW5.DrawingPanel saving animated GIF: " +
    ...
    */
    ...
    private long createTime;               // time at which NguyenHW5.DrawingPanel was constructed
    ...
    public DrawingPanel(int width, int height) {
        ...
        synchronized (getClass()) {
            instances++;
            instanceNumber = instances;  // each NguyenHW5.DrawingPanel stores its own int number
    ...
    // called when NguyenHW5.DrawingPanel closes, to potentially exit the program
    ...
    // compares current NguyenHW5.DrawingPanel image to an image file on disk
    ...
    // compares current NguyenHW5.DrawingPanel image to an image file on the web
...
*/
    ...
    private void saveAsAnimated() {
        ...
        if (filename != null) {
            try {
                ...
                JOptionPane.showMessageDialog(frame,
                        "Due to constraints about how NguyenHW5.DrawingPanel works, you'll need to\n" +
                                "re-run your program.  When you run it the next time, NguyenHW5.DrawingPanel will \n" +
    ...
    // saves NguyenHW5.DrawingPanel image to a temporary file and returns file's name
    ...
    // initializes NguyenHW5.DrawingPanel's menu bar items
