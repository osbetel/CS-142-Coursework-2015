...
/**
 * Class SpaceFrame provides the user interface for a simple simulation
 * program.
 * 
...
public class SpaceFrame extends JFrame {
    private SpaceModel myModel;
    private SpacePanel myPicture;
    ...
    public SpaceFrame(int width, int height) {
        ...
        setTitle("CSC142 Space simulation");
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        myModel = new SpaceModel(width, height);

        // set up critter picture panel
        myPicture = new SpacePanel(myModel);
    ...
    // starts the simulation...assumes all Wildlife have already been added
    public void start() {
        ...
        if (myModel.getCounts().isEmpty()) {
            System.out.println("nothing to simulate--no Wildlife");
            return;
        }
        started = true;
        addClassCounts();
    ...
    public void add(int number, Class<? extends SpaceItem> c) {
